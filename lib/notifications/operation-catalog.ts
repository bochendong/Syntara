...
export const NOTIFICATION_OPERATION_CATALOG: readonly NotificationOperation[] = [
  {
    ...
    domain: 'commerce',
    label: '商城课程复制/购买',
    trigger: '用户从商城复制免费课程、购买课程副本、购买单个笔记本或提交课程评价。',
  ...
  },
  {
    ...
    domain: 'gamification',
    label: '成长奖励与外观解锁',
    trigger: '用户领取成长奖励、结算里程碑、解锁/应用角色、头像框、侧栏样式或通知样式。',
    surfaces: ['toast', 'notification-banner', 'notification-feed'],
    outcomes: ['success', 'error', 'info'],
    sourceFiles: [
      ...
      'components/user-profile/profile-sidebar-panel.tsx',
      'components/user-profile/profile-slide-background-picker.tsx',
      'components/user-profile/profile-notification-style-picker.tsx',
