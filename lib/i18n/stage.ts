export const stageZhCN = {
  ...
  quiz: {
    ...
    retry: '重新答题',
    hubTitle: '全部测验题目',
    hubSubtitle: '按题目浏览，点击开始作答。进度保存在本机；已登录用户与未登录（匿名）分开记录。',
...
export const stageEnUS = {
  ...
  quiz: {
    ...
    retry: 'Retry',
    hubTitle: 'All quiz questions',
    hubSubtitle: 'Browse by question; tap to start. Progress is saved per signed-in user on this device.',
