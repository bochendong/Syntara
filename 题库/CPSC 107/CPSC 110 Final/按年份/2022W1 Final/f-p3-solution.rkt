...
(define visited-at-G  (list "A" "B" "E" "H" "I" "C" "E" "H" "I" "F"))

;; each nn-wl-at answer must be a list of node names "A", "B" etc.
(define nn-wl-at-A  (list))
(define nn-wl-at-E1 (list "C" "D"))
(define nn-wl-at-E2 (list "F" "A" "D"))
(define nn-wl-at-G  (list "D" "A" "A" "D"))
