...
visited is empty, the value of nn-wl is empty, and the value of path-wl is
empty.

We want you to figure out the value of visited, nn-wl, and path-wl at points
...
;; each nn-wl-at answer must be a list of node names "A", "B" etc.
(define nn-wl-at-A  (list))  ;do not change this one, it is correct
(define nn-wl-at-E1 (list ))
(define nn-wl-at-E2 (list ))
(define nn-wl-at-G  (list ))
...
(check-satisfied nn-wl-at-A    is-list-of-string)
(check-satisfied nn-wl-at-E1   is-list-of-string)
(check-satisfied nn-wl-at-E2   is-list-of-string)
(check-satisfied nn-wl-at-G    is-list-of-string)
