...
(@signature Tree -> String)
;; produce concatenation of names in tree
(check-expect (tree-name-string TA)   "A")
(check-expect (tree-name-string TB)   "B")
(check-expect (tree-name-string TFOO) "FOOAB")
(check-expect (tree-name-string TBAR) "BARC")
(check-expect (tree-name-string TTOP) "TOPFOOABBARCD")
