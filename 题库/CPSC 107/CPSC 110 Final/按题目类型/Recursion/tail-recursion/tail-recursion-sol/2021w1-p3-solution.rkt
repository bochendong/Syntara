...
;;  lead to. The label of stairs are always formed the same way and are
...
(define fpsr-path-accumulator?    "yes")
(define fpsr-visited-accumulator? "no")
(define fpsr-worklist?            "no")
(define fpsr-tandem-worklists?    "no")
(define fpsr-try-catch?           "yes")
...
last stairs.
|#
(define fipsr-path-accumulator?    "yes")
(define fipsr-visited-accumulator? "no")
(define fipsr-worklist?            "no")
(define fipsr-tandem-worklists?    "no")
(define fipsr-try-catch?           "yes")
...
|#
(define fepsr-path-accumulator?    "yes")
(define fepsr-visited-accumulator? "no")
(define fepsr-worklist?            "no")
(define fepsr-tandem-worklists?    "no")
(define fepsr-try-catch?           "yes")
