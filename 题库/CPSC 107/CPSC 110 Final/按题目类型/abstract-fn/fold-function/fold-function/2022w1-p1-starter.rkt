...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 2022w1-p1-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
;; DO NOT PUT ANYTHING PERSONALLY IDENTIFYING BEYOND YOUR CWL IN THIS FILE.

(require spd/tags)

(@assignment exams/2022w1-f/f-p1);Do not edit or remove this tag
...
abstract fold function. But be very careful to solve problem 1 in this file 
and problem 2 in the f-p2-starter.rkt file. 
...
additional tests. NOTE THAT:
 ...
 - you must not edit any part of the file except the function definition
   ...
   profs-with-at-least-x-awards FUNCTION DEFINITION.
...
(define (profs-with-at-least-x-awards x prof)
  (fold-prof ... ... ... ... ... prof))
