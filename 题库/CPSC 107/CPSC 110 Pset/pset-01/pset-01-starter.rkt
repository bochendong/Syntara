...
(define img1 (circle 40 "solid" "blue"))
(define img2 (circle 30 "solid" "blue"))
(define img3 (rectangle 20 40 "solid" "red"))

(@htdf taller-image) ;Uncomment this line when you start the problem.
(@signature Image Image -> Image)
;; produces the image that has the greater height; first(second) image if same height
(check-expect (taller-image img1 img2) img1)
(check-expect (taller-image img2 img1) img1)
(check-expect (taller-image img1 img1) img1)
(check-expect (taller-image img3 img1) img1)
