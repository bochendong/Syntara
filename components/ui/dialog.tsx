  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'bg-background ring-foreground/10 grid max-w-3/4 gap-6 rounded-xl p-6 text-sm ring-1 fixed top-1/2 left-1/2 z-50 w-full -translate-x-1/2 -translate-y-1/2',
          className,
        )}
        {...props}
      >
