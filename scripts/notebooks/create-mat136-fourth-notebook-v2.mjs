...
const PAGES = [
  {
    "title": "面积与体积：把几何切成小片",
    "sceneTitle": "面积体积入口",
    "layout": "自然课堂笔记布局：上方标题，左侧从曲线间面积出发，右侧过渡到体积切片，底部给学习路线。",
    "components": [
      {
        "label": "本节问题",
        "role": "opening",
        ...
        "speech": "这一页进入定积分的几何应用。面积和体积看起来是新题型，但核心仍然是把整体切成很多小片，再把小片累加。"
      },
      {
        "label": "面积小片",
        "role": "visual",
        ...
        "speech": "左侧先看面积。两条曲线之间的一条竖直小片，宽度是 dx，高度是上函数减下函数，所以小面积是高度差乘 dx。"
      },
      {
        "label": "体积小片",
        "role": "visual",
        ...
        "speech": "右上转到体积。体积小片不是高度乘宽度，而是截面积乘厚度。只要能写出每片的截面积，就能积分。"
      },
      {
        "label": "统一公式",
        "role": "formula",
      ...
      },
      {
        ...
        "speech": "底部是整本笔记路线。先画区域，再选切片方向，写出小片的量，找到边界，最后用定积分累加。"
      }
    ]
  },
  {
    ...
    "components": [
      {
        ...
        "speech": "曲线间面积的第一步不是积分，而是找区域。先知道哪一块被围住，才能知道从哪里积分到哪里。"
      },
      {
        "label": "竖直小条",
        "role": "visual",
      ...
      },
      {
        ...
        "speech": "于是总面积就是从 a 到 b 积分上边界减下边界。这个公式本质上就是所有小条面积的累加。"
      },
      {
        "label": "交点边界",
        "role": "strategy",
  ...
  },
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "speech": "最后把根号写成 x 的二分之一次方分别积分，结果是三分之一。重点是交点、上下关系和上减下。"
      }
    ]
  },
  {
    ...
    "components": [
      {
        ...
        "speech": "这题出现绝对值，第一件事是把图像和分段结构看清楚。绝对值函数在零点左右表达式不同。"
      },
      {
        "label": "拆绝对值",
        "role": "formula",
  ...
  },
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "speech": "在左段，cos 二 x 在上；过了交点以后，sin 二 x 在上。上下关系发生变化，所以必须分段。"
      },
      {
        "label": "两段积分",
        "role": "formula",
  ...
  },
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "speech": "边长随高度线性缩小，来自相似三角形。从底部量高度 h，边长可以写成七百五十六乘一减 h 除以四百八十一。"
      },
      {
        "label": "体积积分",
        "role": "formula",
    ...
    "components": [
      {
        ...
        "speech": "这一页专门做排错。很多题算错，不是积分不会算，而是一开始把面积和体积的小片写混了。"
      },
      {
        "label": "面积错误",
        "role": "mistake",
      ...
      },
      {
        ...
        "speech": "最后检查四件事：变量是否一致，小片单位是否对，面积或体积是否为正，最后量纲是否合理。"
      }
    ]
  },
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "speech": "最后用四项检查：图像是否清楚，小片是否清楚，上下限是否清楚，最后面积或体积单位是否合理。"
      }
    ]
  }
];
