...
const PAGES = [
  {
    "title": "分部积分：把乘积反向拆开",
    "sceneTitle": "分部积分入口",
    "layout": "自然课堂笔记布局：上方标题，左侧放旧方法遇到的卡点，中央给新想法，右侧给本册路线，底部留一个引导问题。",
    "components": [
      {
        "label": "本册问题",
        "role": "opening",
        ...
        "speech": "这一页先建立本册的核心问题。前面我们会用换元处理“内层和导数”相配的积分，但乘积积分常常不是这种形状，所以要从乘积求导的反方向入手。"
      },
      {
        "label": "旧方法卡点",
        "role": "motivation",
        ...
        "speech": "左侧这些题都在提示同一个困难：它们不是简单换元题。你很难只靠找内层函数和它的导数就完成。"
      },
      {
        "label": "新想法",
        "role": "idea",
        ...
        "speech": "新想法是把乘积法则反过来看。乘积求导会产生两项，而分部积分就是把其中一个乘积积分换成另一个更容易的积分。"
      },
      {
        "label": "学习路线",
        "role": "roadmap",
        ...
        "speech": "本册路线按课堂顺序来：先看公式从哪里来，再学怎么选 u 和 dv，然后进入基础例题、重复分部和混合题。"
      },
      {
        "label": "引导问题",
        "role": "hook",
    ...
    "components": [
      {
        ...
        "marker": "red",
        "content": "写“(uv)′=u′v+uv′”。",
        "speech": "分部积分的起点就是乘积法则。两个函数相乘再求导，会出现两项：一项来自 u 的变化，一项来自 v 的变化。"
      },
      {
        "label": "微分形式",
        "role": "formula",
        ...
        "speech": "把乘积法则写成微分形式，就能看见分部积分里的角色。u dv 和 v du 是同一个乘积变化拆出的两块。"
      },
      {
        "label": "两边积分",
        "role": "formula",
        ...
        "speech": "接下来两边积分。左边直接回到 uv，右边保留两个积分。这个步骤只是把导数关系累加回来。"
      },
      {
        "label": "移项公式",
        "role": "formula",
        ...
        "speech": "把其中一项移到右边，就得到分部积分公式。公式里的减号来自移项，所以之后每道题都要盯住这个符号。"
      },
      {
        "label": "一句话理解",
        "role": "takeaway",
        ...
        "speech": "这页的结论很简单：分部积分不是新魔法，而是反向使用乘积法则。理解来源以后，公式就不只是记忆。"
      }
    ]
  },
  {
    ...
    "components": [
      {
        ...
        "speech": "这页只训练公式位置。左边的 u dv 是原来的积分，右边先写乘积 uv，再减掉新的积分 v du。"
      },
      {
        "label": "选择u",
        "role": "step",
      ...
      },
      {
        ...
        "speech": "dv 的任务是被积分。它必须是我们会直接积分的东西，否则 v 写不出来，公式就走不下去。"
      },
      {
        "label": "生成du和v",
        "role": "step",
        ...
        "speech": "选好 u 和 dv 后，立刻写 du 和 v。很多错误都是因为只写了 u 和 dv，却没有把这两个配套量写清楚。"
      },
      {
        "label": "检查清单",
        "role": "takeaway",
    ...
    "components": [
      {
        ...
        "speech": "选择不是凭感觉。最硬的两个条件是：u 求导后要变轻，dv 要能直接积分。缺一个都很危险。"
      },
      {
        "label": "优先级提示",
        "role": "strategy",
        ...
        "speech": "中间是选 u 的常用优先级：反三角、对数、代数、三角、指数。它是起步提示，不是绝对规则。"
      },
      {
        "label": "快速判断",
        "role": "examples",
        ...
        "speech": "右侧三个判断都符合“求导变简单”。x 变成一，ln x 变成一除以 x，剩下的部分也容易积分。"
      },
      {
        "label": "反例提醒",
        "role": "mistake",
        ...
        "speech": "如果把 dv 选成 ln x dx，就等于假设自己已经会积分 ln x，这会绕回原题。这样的选择没有推进问题。"
      },
      {
        "label": "判断标准",
        "role": "takeaway",
        ...
        "speech": "底部这句话是做题时真正的标准。每一步都问，剩下的积分有没有变简单；如果没有，就回头换选择。"
      }
    ]
  },
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "speech": "让 u 等于 x，因为求导后变成一；让 dv 等于 e 的 x 次方 dx，因为它积分后还是 e 的 x 次方。"
      },
      {
        "label": "套入公式",
        "role": "formula",
        ...
        "speech": "套公式以后，原积分变成 x e 的 x 次方，减去 e 的 x 次方的积分。注意这里没有额外系数。"
      },
      {
        "label": "完成计算",
        "role": "formula",
      ...
      },
      {
        ...
        "speech": "最后可以把 e 的 x 次方提出来，写成 e 的 x 次方乘 x 减一。整理不是必须，但常常更清楚。"
      }
    ]
  },
  {
    ...
    "components": [
      {
        ...
        "speech": "这题是一次式乘三角函数。一次式求导后会变成一，cos x 也容易积分，所以很适合分部积分。"
      },
      {
        "label": "角色选择",
        "role": "formula",
    ...
    "components": [
      {
        ...
        "speech": "当多项式次数大于一时，分部一次可能还不够。这里 x 平方乘 e 的 x 次方通常要连续分部两次。"
      },
      {
        "label": "第一次分部",
        "role": "formula",
        ...
        "speech": "第一次让 u 等于 x 平方，求导后变成二 x。原题变成 x 平方 e 的 x 次方，减去二 x e 的 x 次方的积分。"
      },
      {
        "label": "第二次分部",
        "role": "formula",
      ...
      },
      {
        ...
        "speech": "这页的规律是：多项式被选作 u 时，每分部一次，次数下降一。次数降到零，题目就收尾了。"
      }
    ]
  },
  {
    ...
    "components": [
      {
        ...
        "speech": "不是所有乘积都要分部。sin x 乘 cos x 里面，sin x 的导数正好是 cos x，这时换元更直接。"
      },
      {
        "label": "换元选择",
        "role": "formula",
  ...
  },
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "speech": "先令 t 等于 x 平方。因为 x 三次方 dx 可以拆成 x 平方乘 x dx，所以它变成二分之一 t dt。"
      },
      {
        "label": "变成标准题",
        "role": "formula",
    ...
    "components": [
      {
        ...
        "speech": "这类题不要求把 f 具体算出来，而是要求通过分部积分让两个积分互相抵消，最后只留下 f 和 f 的导数。"
      },
      {
        "label": "第一次分部",
        "role": "formula",
      ...
      },
      {
        ...
        "speech": "对 f 撇除以 x 再分部一次。选 u 等于一除以 x，dv 等于 f 撇 dx，就会出现同样的 f 除以 x 平方积分。"
      },
      {
        "label": "抵消结果",
        "role": "takeaway",
        ...
        "speech": "把第二次分部结果代回，两个含 f 除以 x 平方的积分抵消，只剩 f 撇乘 ln x，减 f 除以 x，加 C。"
      }
    ]
  },
  {
    ...
    "components": [
      {
        ...
        "speech": "分部积分也可以直接用于定积分。和不定积分相比，多出来最重要的是边界项从 a 到 b 的代入。"
      },
      {
        "label": "边界项",
        "role": "concept",
    ...
    "components": [
      {
        ...
        "speech": "这页处理一个反函数积分。题目给了 f 的面积，要求反函数的面积，关键是把反函数积分换回原函数。"
      },
      {
        "label": "换变量",
        "role": "formula",
    ...
    "components": [
      {
        ...
        "speech": "第一个常见错误是角色写不完整。dv 必须包含 dx，而 v 是对 dv 的积分，不是随便抄一个函数。"
      },
      {
        "label": "符号错误",
        "role": "mistake",
        ...
        "speech": "第二个错误是丢掉公式里的减号。尤其遇到三角函数时，积分本身可能再产生负号，要分清两层符号。"
      },
      {
        "label": "选择错误",
        "role": "mistake",
      ...
      },
      {
        ...
        "speech": "最后做题前扫一遍清单：u、dv、du、v 是否齐全，减号是否保留，新积分是否变简单，最后是边界项还是加 C。"
      }
    ]
  },
  {
    "title": "总结：分部积分怎么想",
    "sceneTitle": "总结",
    "layout": "中心放“反向乘积法则”，四周用箭头连接策略、例题类型、混合方法、检查清单，底部一句收束。",
    "components": [
      {
        "label": "核心思想",
        "role": "summary",
      ...
      },
      {
        ...
        "speech": "本册见过的题型包括对数、反三角、代数乘指数、代数乘三角、重复分部，以及先换元再分部的混合题。"
      },
      {
        "label": "最后一句",
        "role": "takeaway",
    ...
    await prisma.$transaction([
      ...
      prisma.notebook.upsert({
        ...
        update: {
          ...
          courseId: course.id,
          name: '分部积分：从乘积法则到选 u',
          description: '第五本中文手绘图片笔记本：分部积分公式、选 u、重复分部、换元结合与典型例题。',
