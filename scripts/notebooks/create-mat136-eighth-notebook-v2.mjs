...
const PAGES = [
  {
    "title": "反常积分：哪里“反常”",
    "sceneTitle": "反常积分入口",
    "layout": "上方标题；左侧区分无限区间；右侧区分函数爆点；中间放“用极限修补积分”；底部给本册问题。",
    "components": [
      {
        "label": "本册问题",
        "role": "opening",
        ...
        "speech": "这一页先说明反常积分的入口。所谓反常，不是积分符号变了，而是积分区间或被积函数出了普通定积分不能直接处理的问题。"
      },
      {
        "label": "无限区间",
        "role": "concept",
        ...
        "speech": "第一类反常来自无限区间。右端写成无穷大时，我们不能直接把无穷大当成普通端点，需要用有限的 t 先截断。"
      },
      {
        "label": "函数爆点",
        "role": "concept",
        ...
        "speech": "第二类反常来自函数本身。即使区间长度有限，只要函数在端点或内部某点爆掉，也必须改用极限定义。"
      },
      {
        "label": "极限思想",
        "role": "strategy",
        ...
        "speech": "处理反常积分的共同思想是先避开危险点，得到一个普通定积分，再让截断点慢慢靠近危险位置。"
      },
      {
        "label": "判断目标",
        "role": "hook",
        ...
        "speech": "底部问题就是每一道题真正要判断的事：极限如果是有限数，积分收敛；如果无穷或不存在，积分发散。"
      }
    ]
  },
  {
    ...
    "components": [
      {
        ...
        "speech": "无限上限的定义就是把无穷大先换成有限的 t，算从 a 到 t 的普通积分，然后令 t 走向无穷大。"
      },
      {
        "label": "面积函数",
        "role": "visual",
        ...
        "speech": "中间这块把积分看成随 t 变化的面积函数。我们关心的不是某个 t 的面积，而是 t 越来越大时面积有没有稳定下来。"
      },
      {
        "label": "收敛例子",
        "role": "example",
    ...
    "components": [
      {
        ...
        "speech": "无穷远的 p 积分是反常积分最重要的模板。指数 p 大于一时，尾巴衰减足够快；p 小于等于一时不够快。"
      },
      {
        "label": "收敛推导",
        "role": "derivation",
      ...
      },
      {
        ...
        "speech": "图像上两条曲线都趋近零，但面积表现不同。只看函数值趋近零不够，还要看尾巴面积是否可累积成有限数。"
      },
      {
        "label": "记忆句",
        "role": "takeaway",
  ...
  },
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "speech": "这一块把常见极限放在一起：指数尾项消失，反正切有水平极限，对数会继续增长。"
      },
      {
        "label": "模板提醒",
        "role": "takeaway",
  ...
  },
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "speech": "在零附近的 p 积分中，p 大于等于一会发散。这里三分之二次方的指数是一点五，所以发散。"
      },
      {
        "label": "比较方向",
        "role": "strategy",
    ...
    "components": [
      {
        ...
        "speech": "这题提醒我们：函数来回振荡，不代表反常积分自动收敛。仍然要按定义看截断积分的极限。"
      },
      {
        "label": "截断计算",
        "role": "derivation",
    ...
    "components": [
      {
        ...
        "speech": "有理函数的第一步是看分母在哪里等于零。只要区间内部有分母为零，就必须把它当作反常点处理。"
      },
      {
        "label": "因式分解",
        "role": "formula",
    ...
    "components": [
      {
        ...
        "speech": "部分分式是处理有理函数积分的主要工具。看到分母可以因式分解，就先考虑把复杂分母拆成简单分母。"
      },
      {
        "label": "不同线性因子",
        "role": "template",
  ...
  },
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "speech": "因为分母有 x 减一和 x 减二两个不同线性因子，所以设成 A 除以 x 减一，加 B 除以 x 减二。"
      },
      {
        "label": "通分",
        "role": "derivation",
    ...
    "components": [
      {
        ...
        "speech": "复杂分母里有一个线性因子和一个重复的二次因子，所以二次因子的一次方和二次方都要写出来。"
      },
      {
        "label": "比较系数",
        "role": "calculation",
      ...
      },
      {
        ...
        "speech": "而一除以 x 平方加一的平方，则常用三角代换 x 等于 tan θ，把 x 平方加一变成 sec 平方。"
      },
      {
        "label": "方法选择",
        "role": "takeaway",
    ...
    "components": [
      {
        ...
        "speech": "最后一页把本册收束起来。反常积分本质上仍然是普通积分，只是要在危险点处补上极限判断。"
      },
      {
        "label": "高斯模板",
        "role": "formula",
      ...
      },
      {
        ...
        "speech": "做反常积分时，可以按这四步走：先找危险点，再拆区间，然后选择直接计算或比较法，最后确认每段极限有限。"
      },
      {
        "label": "最后一句",
        "role": "takeaway",
    ...
    await prisma.$transaction([
      ...
      prisma.notebook.upsert({
        ...
        update: {
          ...
          description: '第八本中文手绘图片笔记本：反常积分、p-积分、比较判别、拆区间、部分分式与高斯型换元。',
