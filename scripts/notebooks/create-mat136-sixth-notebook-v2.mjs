...
const PAGES = [
  {
    "title": "微分方程：从变化率找函数",
    "sceneTitle": "微分方程入口",
    "layout": "自然课堂笔记布局：上方标题，左侧从变化率出发，中间画未知函数曲线，右侧列本册路线，底部放核心问题。",
    "components": [
      {
        "label": "本册问题",
        "role": "opening",
        ...
        "speech": "这一页进入微分方程。普通积分是已知导数去找函数；微分方程也是这个思想，但导数可能同时依赖 x、y 或其他变量。"
      },
      {
        "label": "变化率信息",
        "role": "concept",
        ...
        "speech": "左侧先抓住概念：dy 除以 dx 不是一个孤立公式，它告诉曲线在当前位置的斜率，也就是下一步该往哪里走。"
      },
      {
        "label": "未知函数",
        "role": "visual",
      ...
      },
      {
        ...
        "speech": "本册路线从最基础的积分解法开始，再看初值如何确定常数，接着看积分形式的解、斜率场和欧拉方法。"
      },
      {
        "label": "引导问题",
        "role": "hook",
    ...
    "components": [
      {
        ...
        "speech": "这个例子变量不是 x 和 y，而是体积 V 和压力 P。方法不变：导数告诉我们 V 随 P 怎么变。"
      },
      {
        "label": "分离形式",
        "role": "formula",
  ...
  },
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "speech": "从 a 走到 x，函数值的变化量就是导数 g(t) 的累积，所以 y(x) 等于初始值加上这段积分。"
      },
      {
        "label": "变量 t",
        "role": "concept",
  ...
  },
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "speech": "底部流程就是匹配斜率场的顺序：先看依赖谁，再找零斜率，再判断正负区域，最后才选图。"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "speech": "初始数量七在六和二十之间。只需要判断这个区间里 dN/dt 的符号，就知道数量先往哪里走。"
      },
      {
        "label": "趋势箭头",
        "role": "strategy",
  ...
  },
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "speech": "目标里有负三 x 平方，所以常常要检查上限是不是负 x 三次方，或者 integrand 是否已经带了负号。"
      },
      {
        "label": "选择流程",
        "role": "takeaway",
  ...
  },
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "speech": "最后清单帮助做题：分离变量，代初值，求导检查积分形式，读斜率场，再用凹凸判断欧拉误差。"
      }
    ]
  },
  {
